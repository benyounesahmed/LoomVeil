...
#[derive(Debug)]
pub struct LoomVeilProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LoomVeilProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LoomVeil processing");
    
    let mut processor = LoomVeilProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LoomVeilProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LoomVeilProcessor::new(false);
